...
public class ProductController
{
	...
	public String getProductById(@RequestParam("id") String argProductId, Model argModel)
	{
		argModel.addAttribute("product", this.productService.getProductById(argProductId));
		return "product";
	}
